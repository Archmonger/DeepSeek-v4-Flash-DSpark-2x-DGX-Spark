...
class PatchTransactionTests(unittest.TestCase):
    ...
    def test_issue138_then_agent_message_patch_is_compatible(self):
...
class InjectedSemanticsTests(unittest.TestCase):
    ...
    def test_minimal_and_multi_part_input_text_forms_are_accepted(self):
        for content in (
            ...
            with self.subTest(parts=len(content)):
                original = {
                    "type": "agent_message",
                    "id": "amsg_1",
                    "author": "/root",
